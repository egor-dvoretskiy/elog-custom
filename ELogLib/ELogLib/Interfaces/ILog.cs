...
namespace ELogLib.Interfaces
{
    internal interface ILog
    {
        ...
        void Trace(string message, PrintLevel printLevel = PrintLevel.One, [CallerMemberName] string callerName = "");

        /// <summary>
        /// For debugging and development. Use with caution in production due to the high volume.
        /// </summary>
        /// <param name="message">Standart log message.</param>
        void Info(string message, PrintLevel printLevel = PrintLevel.One, [CallerMemberName] string callerName = "");

        /// <summary>
        /// Tracks the general flow of the app. May have long-term value.
        /// </summary>
        /// <param name="message">Standart log message.</param>
        void Debug(string message, PrintLevel printLevel = PrintLevel.One, [CallerMemberName] string callerName = "");

        /// <summary>
        /// For abnormal or unexpected events. Typically includes errors or conditions that don't cause the app to fail.
        /// </summary>
        /// <param name="message">Standart log message.</param>
        void Warning(string message, PrintLevel printLevel = PrintLevel.One, [CallerMemberName] string callerName = "");
        ...
        /// <param name="message">Standart log message.</param>
        void Error(string message, PrintLevel printLevel = PrintLevel.One, [CallerMemberName] string callerName = "");
        ...
        /// <param name="message">Standart log message.</param>
        void Decide(bool decision, string message, PrintLevel printLevel = PrintLevel.One, [CallerMemberName] string callerName = "");
    }
}
